...
header
  display: grid
  // grid: minmax($height-header, max-content ) / $sidebarWidthIcon max-content auto $sidebarWidthIcon // row/col
  grid: minmax($height-header, max-content ) / $sidebarWidthIcon auto max-content // row/col
  width: 100%
  overflow: hidden
  user-select: none
