<template>
  <header
    class="header-layout-main-challenges"
    @click="clickHeader"
  >
    ...
    <div class="header-main">
      ...
      >
        ...
        <NuxtLink
          v-if="!isAuthTest"
          to="/challenges/register-user"
          class="btn btn-link mobile-hidden"
        >
          Регистрация
        </NuxtLink>
        ...
        <button
          v-if="isAuthTest"
          class="btn-avatar button-default-style-none"
        >
          ...
          <div class="user-avatar-wrap">
            <img
              ...
              height="32"
              width="32"
              src="https://avatars.githubusercontent.com/u/59876378?s=60&v=4"
            >
          </div>
        </button>

        <div
          class="header-user-block-menu"
          v-if="isAuthTest"
        >
          <SidenavItemOnlyLink
