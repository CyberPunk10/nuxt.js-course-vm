<template>
  <div class="form-sport-tabs-wrap">
    ...
    <div @click="clickOnTab" class="form-sport-tabs">
      <div class="shadow"></div>
      <!-- tab 1 -->
      <div :class="{active: activeTab == 1}" class="tab tab1">
        <div class="shadow"></div>
        ...
        <svg class="svg-right-tab" preserveAspectRatio="none" viewBox="0 0 42 47" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path data-tab="1" fill-rule="evenodd" clip-rule="evenodd"
            d="M9.53674e-07 0H42C34.0755 0 31.3019 3.18646 22.9811 23.5C14.6604 43.8136 9.90566 47 9.53674e-07 47V0Z">
      ...
      <!-- tab 2 -->
      <div :class="{active: activeTab == 2}" class="tab tab2">
        <div class="shadow"></div>

        <svg data-tab="2" class="svg-left-tab" preserveAspectRatio="none" viewBox="0 0 42 47" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path data-tab="2" fill-rule="evenodd" clip-rule="evenodd"
            d="M9.53674e-07 0H42C34.0755 0 31.3019 3.18646 22.9811 23.5C14.6604 43.8136 9.90566 47 9.53674e-07 47V0Z">
            <!-- <animate attributeName="d" dur="10000ms" repeatCount="20" fill="freeze" calcMode="linear"
              restart="whenNotActive"
              values="M0 0H27.5C27.5 10 27.5001 32 27.5 44.5C27.5 57 22.0001 59 0 59V0Z;
        ...
        <div data-tab="2" class="content">
          <svg data-tab="2" width="26" height="26" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">

            <path data-tab="2" d="M488.399,492h-21.933V173.536c0-14.823-12.06-26.882-26.882-26.882H390.56c-14.823,0-26.882,12.06-26.882,26.882V492
            ...
            <path data-tab="2" d="M466.442,10.516c0.14-2.729-0.82-5.504-2.904-7.588c-2.084-2.084-4.859-3.045-7.588-2.904
            ...
            <circle data-tab="2" cx="75.64" cy="303.31" r="10"/>
        ...
        <svg class="svg-right-tab" preserveAspectRatio="none" viewBox="0 0 42 47" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path data-tab="2" fill-rule="evenodd" clip-rule="evenodd"
            d="M9.53674e-07 0H42C34.0755 0 31.3019 3.18646 22.9811 23.5C14.6604 43.8136 9.90566 47 9.53674e-07 47V0Z" fill="#ffd438">
            <!-- <animate attributeName="d" dur="10000ms" repeatCount="20" fill="freeze" calcMode="linear"
              restart="whenNotActive"
              values="M0 0H27.5C27.5 10 27.5001 32 27.5 44.5C27.5 57 22.0001 59 0 59V0Z;
              M0 0H53C43 0 39.5 4.00002 29 29.5C18.5 55 12.5 59 0 59V0Z;">
      ...
      <!-- tab 3 -->
      <div :class="{active: activeTab == 3}" class="tab tab3">
        <div class="shadow"></div>

        <svg data-tab="3" class="svg-left-tab" preserveAspectRatio="none" viewBox="0 0 42 47" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path data-tab="3" fill-rule="evenodd" clip-rule="evenodd"
            d="M9.53674e-07 0H42C34.0755 0 31.3019 3.18646 22.9811 23.5C14.6604 43.8136 9.90566 47 9.53674e-07 47V0Z">
            <!-- <animate attributeName="d" dur="10000ms" repeatCount="20" fill="freeze" calcMode="linear"
              restart="whenNotActive"
              values="M0 0H27.5C27.5 10 27.5001 32 27.5 44.5C27.5 57 22.0001 59 0 59V0Z;
        ...
        <div data-tab="3" class="content">
          <svg data-tab="3" version="1.1" width="26" height="26" fill="$theme-color-black" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 480 480" style="enable-background:new 0 0 480 480;" xml:space="preserve">

            <path data-tab="3" d="M296,280h-8.8c-3.31,0.006-6.271-2.059-7.408-5.168c-0.976-2.56-2.024-5.064-3.152-7.544
            ...
            <path data-tab="3" d="M231.84,316.8c-0.08-1.92-0.216-3.832-0.448-5.736c-0.256-2.048-0.56-4.08-0.984-6.072c-0.28-1.304-0.648-2.592-1-3.888
            ...
            <path data-tab="3" d="M456,168h-25.16c-3.355,0.034-6.356-2.079-7.456-5.248c-2.481-7.431-5.483-14.679-8.984-21.688
            ...
            <path data-tab="3" d="M337.536,142.464c-40.638-40.553-106.434-40.553-147.072,0c-3.069,3.178-2.981,8.243,0.197,11.312
...
.form-sport-tabs
  ...
  button
    ...
    user-select: none
    // box-shadow: 0 16px 16px rgba(130, 100, 0,.04)
