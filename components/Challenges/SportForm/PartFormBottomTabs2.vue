<template>
  <div @click="clickOnTab" class="form-sport-tabs-2">
    <div class="shadow"></div>
    <!-- tab 1 -->
    <div :class="{active: activeTab == 1}" class="tab tab1">
      <div data-tab="1" class="content">
        <!-- Сохранить -->
        <button @click="save" data-tab="1">Сохранить</button>
      </div>
    ...
    <div :class="{active: activeTab == 3}" class="tab tab3">
      ...
      <div data-tab="3" class="content">
        <svg data-tab="3" version="1.1" width="26" height="26" fill="#2a2424" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
